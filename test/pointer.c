...
int main() {
  ...
  ASSERT(3, ({ int arr[2]; int *x = &arr; *x = 3; *arr; }));

  ASSERT(3, ({ int arr[3]; *arr = 3; *(arr + 1) = 4; *(arr + 2) = 5; *arr; }));
  ASSERT(4, ({ int arr[3]; *arr = 3; *(arr + 1) = 4; *(arr + 2) = 5; *(arr + 1); }));
  ASSERT(5, ({ int arr[3]; *arr = 3; *(arr + 1) = 4; *(arr + 2) = 5; *(arr + 2); }));
  ...
  ASSERT(0, ({ int x[2][3][4]; int *y = x; *y = 0; ***x; }));
