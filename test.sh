...
assert 1 'int main() {return 51==51;}' 
assert 1 'int main() {return 0!=1;}'
assert 0 'int main() {return 51!=51;}'
...
assert 9 'int main() {int a = 2; int z = 7; return a + z;}'
assert 6 'int main() {int a; int b; a = b = 3; return a+b;}'
assert 2 'int main() {int skibidi = 2; return skibidi;}'
assert 8 'int main() {int skibidi123 = 3; int variable = 5; return skibidi123 + variable;}'
...
assert 69 'int main() { if (1) return 69; return 4; }'
assert 69 'int main() { if (2 - 1) return 69; return 4; }'
assert 4 'int main() { if (0) { 1; 2; return 3; } else { return 4; } }'
assert 3 'int main() { if (1) { 1; 2; return 3; } else { return 4; } }'

assert 55 'int main() {int i = 0; int j = 0; for (i = 0; i <= 10; i = i + 1) j = i + j; return j; }'
assert 69 'int main() { for (;;) {return 69;} return 6; }'

assert 6 'int main() { int i = 0; while (i < 6) { i = i  + 1; } return i; }'
...
assert 3 'int main() { int arr[2]; int *x = &arr; *x = 3; return *arr; }'

assert 3 'int main() { int arr[3]; *arr = 3; *(arr + 1) = 4; *(arr + 2) = 5; return *arr; }'
...
assert 255 'int main() { return "\x0ff"[0]; }'
